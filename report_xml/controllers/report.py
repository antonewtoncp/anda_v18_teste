...
class ReportController(report.ReportController):
    ...
    def report_download(self, data, context=None, token=None):
        #self.env['ir.module.module'].search([('name','in',['tis_hr_biometric_attendance','anda_report','anda_dashboard','purchase_request','investment','timeboxed_connector','delivery_fedex_rest'])])
